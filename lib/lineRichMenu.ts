...
export function richMenuReply(text: string): object[] | null {
  ...
  // เมนูเก่ามีปุ่ม "เร็วๆนี้" ที่เคยบล็อกเดินทาง — ตอนนี้ใช้ได้แล้ว
  // แสดงการ์ดเลือกคำสั่งจริง ไม่ส่งข้อความ "กำลังอัปเกรด"
  if (
    t === "เร็วๆนี้" ||
    norm === "เร็วๆนี้" ||
    t === "เร็วๆ นี้" ||
    ...
    return [
      menuCard("🚗 วางแผนเดินทาง", "ตั้งบ้าน/ที่ทำงานไว้ครั้งเดียว แล้วถามได้เลย", [
        { label: "ไปทำงานพรุ่งนี้", text: "วางแผนเดินทางไปทำงานพรุ่งนี้", sub: "บอกเวลาที่ควรออกจากบ้าน" },
        { label: "กลับบ้านวันนี้", text: "วางแผนเดินทางกลับบ้าน", sub: "เผื่อเวลากลับหลังเลิกงาน" },
        { label: "เปิดแผนที่ไปทำงาน", text: "เปิดแผนที่ไปที่ทำงาน", sub: "นำทางเดี๋ยวนี้" },
        { label: "ตั้งที่ทำงาน / บ้าน", text: "ตั้งค่า", sub: "ปักหมุดที่หน้าตั้งค่า" },
      ]),
    ];
  }
