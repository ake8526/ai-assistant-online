...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    match: /สลิป(?:เงินเดือน)?|เงินเดือน|โอที|ค่าล่วงเวลา|ภาษี\s*หัก|ประกันสังคม|กองทุนสำรอง/,
  },
  {
    key: "hr",
  ...
  },
  {
    key: "room",
    topic: "จองห้องประชุม",
    match: /จองห้อง|ห้องประชุมว่าง|ห้องไหนว่าง|ห้อง\s*(?:ประชุม)?\s*ว่างไหม/,
    instead: "นัดประชุมแล้วใส่ชื่อห้องไว้ในหัวข้อได้ ระบบจะส่งนัดเข้า Outlook ให้",
    suggestions: [{ label: "นัดประชุม", text: "นัดประชุม" }],
  },
  {
    key: "car",
